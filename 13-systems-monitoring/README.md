...
Нужно сделать уровни обслуживания SLA, SLO и SLI. В качестве метрики использовать SLI.

Далее, более подробно вместе с менеджером определим основные метрики SLI, которые будем использовать.

Например:
Time-Based индикатор
...
Для таких задач подойдет Sentry.
```
#
...
```
 В файл добавил метрики telegraf.conf

[[inputs.disk]]
[[inputs.mem]]
```
<p align="center">
  <img width="1200" src="explore-1.jpg">
</p>
#
...
```
<p align="center">
  <img width="1200" src="explore-2.jpg">
</p>
