...
```
touch {000001…100000}
300000 - нет, очень большое число.
```
...
В нашем примере мне bash вернул 0.
```
...
batch - отрабатывает, когда уровень загрузки системы снизится ниже 1.5.
```
