...
token: y0_AgAAA********************wQAAAADT5DZkPFdH1wUSQXef1ejzte5OnZFU6qQ
cloud-id: b1gnjst4dee7j34hrh7s
folder-id: b1gd02p4ii36h57v2h14
...
Я создал образ через packer. Предварительно описал конфигурацию в json файле.

2. Ссылку на репозиторий с исходной конфигурацией терраформа.  
 
 oot@vagrant:~/cloud-terraform# terraform plan
var.OAUTH
  Enter a value: y0_AgAAAAAFc1Gr******************FdH1wUSQXef1ejzte5OnZFU6qQ
...
"terraform apply" now.
 ...
 ```
 Cсылка на терраформ файлы <a href="https://github.com/awertoss/devops-netology/tree/main/terraform">здесь</a>.
---
